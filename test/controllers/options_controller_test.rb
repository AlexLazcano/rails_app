...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference("Option.count") do
      post options_url, params: { option: { poll_id: @option.poll_id, text: @option.text, votes: @option.votes } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { poll_id: @option.poll_id, text: @option.text, votes: @option.votes } }
